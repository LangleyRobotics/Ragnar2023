...
public class TelescopeWithLiftCmd extends CommandBase{
    ...
    public TelescopeWithLiftCmd(LiftSubsystem liftSubsystem, Supplier<Double> telescopeSpeed, Supplier<Integer> telescopeDirection, 
    ...
    public void execute() {
        ...
        liftSubsystem.setLiftMotor(0.5*liftVel);
